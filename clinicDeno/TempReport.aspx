<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TempReport.aspx.cs" Inherits="clinicDeno.TempReport" %>
    ...
    <section class="vertical-middle-landing">
        <div class="box-style box-desktop-950 item-center">
            ...
            <asp:Panel ID="allRecords" runat="server" class="record-inputField input-section-gap">
                ...
                <div class="recordinputHeader-row">
                    <p class="montserrat grey-blue-second bold-font font-size-11">Medical Certificate</p>
                </div>
                <asp:Label runat="server"  class="record-titlesnew">Start Date:</asp:Label>
                <asp:Label runat="server"  class="records" ID="SDate"></asp:Label>
                <asp:Label runat="server"  class="record-titles">End Date:</asp:Label>
                <asp:Label runat="server"  class="records" ID="EDate"></asp:Label>
                <asp:Label runat="server"  class="record-titlesnew">Comments:</asp:Label>
                <asp:Label runat="server"  class="records" ID="Comments"></asp:Label>
