...
{
    public partial class DoctorUpcomingAppointments : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["LoggedIn"] != null && Session["AuthToken"] != null && Request.Cookies["AuthToken"] != null && Session["ID"] != null)
            {
                ...
                else
                {
                    ...
                    {
                        appointmentActionMsg.Visible = true;
                    }
                    else
                    {
                        appointmentActionMsg.Visible = false;
                    }
                }
            }
            else
        ...
        private void PopulateAllAppointments()
        {
            ...
            eList = client.GetAppointmentByDoctorId(Session["ID"].ToString()).ToList<Appointment>();
            string jsonString = "";
