            ...
            if (jsonDataString != "") {
                ...
                for (let i = 0; i < dataArray.length; i++) {
                    ...
                    <div class="rowEntry-action-layout">
                        <a  class="montserrat rounded-full standard-btn btn-standard-width y-gap" runat="server" href="~/AdminDashboard_Upcoming_Details.aspx?appointmentId=${rowDataArray[0]}">View Details</a>
                    </div>
                </article>`
